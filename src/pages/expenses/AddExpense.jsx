...
const AddExpense = () => {
	...
	const [recurrent, setRecurrent] = useState(undefined)
			...
			<form className="mx-auto max-w-md" onSubmit={handleSubmit} autoComplete="off">
				...
				<div className="group relative z-0 mb-5 w-full">
					...
					<label
						...
						className="absolute top-3 -z-10 origin-[0] -translate-y-6 scale-75 transform text-sm text-chestnut-400 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:start-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:font-medium peer-focus:text-chestnut-600 dark:text-gray-400 peer-focus:dark:text-chestnut-500 rtl:peer-focus:translate-x-1/4"
					>
						Day of the month the expense will be paid
					</label>
				</div>
				<div className="group relative z-0 mb-5 w-full">
					<label
	...
	return (
		<main className="flex h-full w-full flex-col [grid-area:main]">
			<div className="h-full w-auto">
				<h1 className="mb-5 mt-20 text-center text-2xl text-chestnut-700">
					Add a new {recurrent ? 'recurrent' : ''} expense 💸{recurrent ? '🗓️' : ''}
				</h1>

				<div className="flex justify-center">
					<button
						onClick={() => setRecurrent(true)}
						className="focus:ring-4dark:bg-chestnut-600 m-4 bg-chestnut-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-chestnut-800 dark:hover:bg-chestnut-700 dark:focus:ring-chestnut-800"
					>
						Recurrent
					</button>
					<button
						onClick={() => setRecurrent(false)}
						className="m-4 bg-chestnut-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-chestnut-800 dark:bg-chestnut-600 dark:hover:bg-chestnut-700 dark:focus:ring-chestnut-800"
					>
						Not recurrent
					</button>
				</div>
